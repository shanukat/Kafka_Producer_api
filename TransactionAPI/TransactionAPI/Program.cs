...
builder.Logging.AddLog4Net(); //add Log4net
...
var topic = builder.Configuration.GetValue<string>("TopicName");
builder.Services.AddSingleton(new ProducerService(producerConfiguration, topic));
